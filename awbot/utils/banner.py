"""Banner creation and formatting utilities for awbot."""
...
from awbot.utils.ascii import awbot
...
class BannerBuilder:
    ...
    def _create_banner_table(self) -> Table:
        ...
        info_data = [
            ...
            ("Bot Name", f"{self.config.bot_name} (awbot)"),
    ...
    def build(self) -> Panel:
        ...
        return Panel(
            content,
            title=f"[bold {self.config.colors.primary}]awbot[/]",
