...
class Config:
    ...
    def __init__(self, dotenv_path: Path | None = None, load_env: bool = True):
        ...
        if self.workspace_root.name == "awbot":
            # If we're in the awbot package, this is the workspace root
            pass
        elif self.workspace_root.parent.name == "awbot":
            # If we're in tests/awbot, go up one more level
