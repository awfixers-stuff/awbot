"""Core CLI functionality for awbot.
...
@click.version_option(version=__version__, prog_name="awbot")  # type: ignore[misc]
@click.pass_context
def cli(ctx: Context) -> None:  # Remove env_dev and env_prod params
    ...
    # else: invoked_command is None (e.g., `awbot --help`), no DB needed.
...
def show_version() -> int:
    """Display the current version of awbot"""
