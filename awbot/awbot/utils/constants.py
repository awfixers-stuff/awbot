...
class Constants:
    ...
    EMBED_ICONS: Final[dict[str, str]] = {
        ...
        "ACTIVE_CASE": "https://github.com/allthingslinux/awbot/blob/main/assets/embeds/active_case.png?raw=true",
        "INACTIVE_CASE": "https://github.com/allthingslinux/awbot/blob/main/assets/embeds/inactive_case.png?raw=true",
        "ADD": "https://github.com/allthingslinux/awbot/blob/main/assets/emojis/added.png?raw=true",
        "REMOVE": "https://github.com/allthingslinux/awbot/blob/main/assets/emojis/removed.png?raw=true",
        "BAN": "https://github.com/allthingslinux/awbot/blob/main/assets/emojis/ban.png?raw=true",
        "JAIL": "https://github.com/allthingslinux/awbot/blob/main/assets/emojis/jail.png?raw=true",
        "KICK": "https://github.com/allthingslinux/awbot/blob/main/assets/emojis/kick.png?raw=true",
        "TIMEOUT": "https://github.com/allthingslinux/awbot/blob/main/assets/emojis/timeout.png?raw=true",
        "WARN": "https://github.com/allthingslinux/awbot/blob/main/assets/emojis/warn.png?raw=true",
    }
