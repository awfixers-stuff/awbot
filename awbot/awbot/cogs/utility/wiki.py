...
class Wiki(commands.Cog):
    ...
    def create_embed(self, title: tuple[str, str], ctx: commands.Context[awbot]) -> discord.Embed:
        """
    ...
    async def wiki(self, ctx: commands.Context[awbot]) -> None:
        """
    ...
    async def arch_wiki(self, ctx: commands.Context[awbot], query: str) -> None:
        """
    ...
    async def atl_wiki(self, ctx: commands.Context[awbot], query: str) -> None:
        """
