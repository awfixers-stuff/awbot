...
from awbot.utils.converters import get_channel_safe
...
class Starboard(commands.Cog):
    ...
    @commands.guild_only()
    @checks.has_pl(5)
    async def starboard(self, ctx: commands.Context[awbot]) -> None:
        """
    ...
    @checks.has_pl(5)
    async def remove_starboard(self, ctx: commands.Context[awbot]) -> None:
        """
