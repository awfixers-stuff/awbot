...
from awbot.utils.exceptions import PermissionLevelError
...
class SnippetsBaseCog(commands.Cog):
    ...
    async def check_if_user_has_mod_override(self, ctx: commands.Context[awbot]) -> bool:
    ...
    async def _get_snippet_or_error(self, ctx: commands.Context[awbot], name: str) -> Snippet | None:
    ...
    async def send_snippet_error(self, ctx: commands.Context[awbot], description: str) -> None:
