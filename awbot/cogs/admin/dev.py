...
class Dev(commands.Cog):
    ...
    @commands.guild_only()
    @checks.has_pl(8)
    async def dev(self, ctx: commands.Context[awbot]) -> None:
        """
    ...
    @commands.guild_only()
    @checks.has_pl(8)
    async def sync_tree(self, ctx: commands.Context[awbot], guild: discord.Guild) -> None:
        """
    ...
    @commands.guild_only()
    @checks.has_pl(8)
    async def clear_tree(self, ctx: commands.Context[awbot]) -> None:
        """
    ...
    @commands.guild_only()
    @checks.has_pl(8)
    async def emoji(self, ctx: commands.Context[awbot]) -> None:
        """
    ...
    @commands.guild_only()
    @checks.has_pl(8)
    async def sync_emojis(self, ctx: commands.Context[awbot]) -> None:
        """
    ...
    @commands.guild_only()
    @checks.has_pl(8)
    async def resync_emoji(self, ctx: commands.Context[awbot], emoji_name: str) -> None:
        """
    ...
    @commands.guild_only()
    @checks.has_pl(8)
    async def delete_all_emojis(self, ctx: commands.Context[awbot]) -> None:
        """
    ...
    @commands.guild_only()
    @checks.has_pl(8)
    async def list_emojis(self, ctx: commands.Context[awbot]) -> None:
        """
    ...
    @commands.guild_only()
    @checks.has_pl(8)
    async def load_cog(self, ctx: commands.Context[awbot], *, cog: str) -> None:
        """
    ...
    @commands.guild_only()
    @checks.has_pl(8)
    async def unload_cog(self, ctx: commands.Context[awbot], *, cog: str) -> None:
        """
    ...
    @commands.guild_only()
    @checks.has_pl(8)
    async def reload_cog(self, ctx: commands.Context[awbot], *, cog: str) -> None:
        """
    ...
    @commands.guild_only()
    @checks.has_pl(8)
    async def stop(self, ctx: commands.Context[awbot]) -> None:
        """
        Stops the bot. If awbot is running with Docker Compose, this will restart the container.
        ...
        await ctx.send(
            "Stopping the bot...\n-# Note: if awbot is running with Docker Compose, this will restart the container.",
        )
