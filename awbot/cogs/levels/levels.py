...
from awbot.cogs.services.levels import LevelsService
from awbot.database.controllers import DatabaseController
from awbot.ui.embeds import EmbedCreator, EmbedType
...
class Levels(commands.Cog):
    ...
    async def set(self, ctx: commands.Context[awbot], member: discord.Member, new_level: int) -> None:
        """
    ...
    async def set_xp(self, ctx: commands.Context[awbot], member: discord.Member, xp_amount: int) -> None:
        """
    ...
    async def reset(self, ctx: commands.Context[awbot], member: discord.Member) -> None:
        """
    ...
    async def blacklist(self, ctx: commands.Context[awbot], member: discord.Member) -> None:
        """
