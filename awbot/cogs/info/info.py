...
class Info(commands.Cog):
    ...
    @commands.guild_only()
    async def server(self, ctx: commands.Context[awbot]) -> None:
        """
    ...
    @commands.guild_only()
    async def member(self, ctx: commands.Context[awbot], member: discord.Member) -> None:
        """
    ...
    @commands.guild_only()
    async def roles(self, ctx: commands.Context[awbot]) -> None:
        """
    ...
    async def emotes(self, ctx: commands.Context[awbot]) -> None:
        """
