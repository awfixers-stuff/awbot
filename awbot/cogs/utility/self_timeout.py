...
from awbot.cogs.utility import add_afk, del_afk
from awbot.database.controllers import DatabaseController
from awbot.ui.views.confirmation import ConfirmationDanger
from awbot.utils.functions import convert_to_seconds, generate_usage, seconds_to_human_readable
...
class SelfTimeout(commands.Cog):
    ...
    @commands.guild_only()
    async def self_timeout(self, ctx: commands.Context[awbot], duration: str, *, reason: str = "No Reason.") -> None:
        """
