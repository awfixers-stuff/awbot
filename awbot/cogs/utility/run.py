...
from awbot.wrappers import godbolt, wandbox
...
class Run(commands.Cog):
    ...
    async def _extract_code_from_message(self, ctx: commands.Context[awbot], code: str | None) -> str | None:
        """
    ...
    async def run(self, ctx: commands.Context[awbot], *, code: str | None = None) -> None:
        """
    ...
    async def languages(self, ctx: commands.Context[awbot]) -> None:
        """
