...
export const config = {
  matcher: [
    // Protect everything except exempted paths and static files
    "/((?!_next|static|public|favicon.ico|robots.txt|manifest.json|api/verify-turnstile|sign-in|sign-up|turnstile-challenge).*)",
  ],
};